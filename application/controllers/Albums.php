...
class Musik extends CI_Controller
{
    ...
    public function add()
    {
        $this->form_validation->set_rules('artis', 'Nama Alat', 'required', array('required' => '%s Mohon Untuk Diisi !!!'));
        $this->form_validation->set_rules('judul', 'judul Alat', 'required', array('required' => '%s Mohon Untuk Diisi !!!'));
        ...
        if ($this->form_validation->run() == TRUE) {
            $config['upload_path'] = './assets/musik';
            $config['allowed_types'] = 'gif|jpg|png|jpeg|ico|mp3|mp4';
            ...
            if (!$this->upload->do_upload($field_name)) {
                ...
                $config['source_image'] = './assets/musik' . $upload_data['uploads']['file_name'];
                ...
                $data = array(
                    ...
                    'musik' => $upload_data['uploads']['file_name'],
                );
